            ...
            <div class="mt-3 text-center sm:mt-0 sm:text-left">
              ...
              <div class="mt-2">
                ...
                <div class=" px-4 py-3 mb-3 sm:flex sm:flex-row-reverse sm:px-6">
                    <button type="button" class="inline-flex w-full justify-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 ">Ok!</button>
                </div>
              </div>
            </div>
          </div>
